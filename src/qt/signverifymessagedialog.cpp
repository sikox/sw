    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a SkyWay address (e.g. SXDFxY8LNb4QdfW4wh8HmGpYLdh5bLxMD5)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a SkyWay address (e.g. SXDFxY8LNb4QdfW4wh8HmGpYLdh5bLxMD5)"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter SkyWay signature"));
#endif
