...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("SW");
    case mBTC: return QString("mSW");
    case uBTC: return QString::fromUtf8("μSW");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("SkyWays"));
    case mBTC: return QString(QObject::tr("Milli-SkyWays (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-SkyWays (1 / 1,000,000)"));
    default: return QString("???");
    }
}
